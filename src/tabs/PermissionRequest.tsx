    ...
    <div className="container permission-request">
      <div className="inner-container">
        ...
        <p className="text-color paragraph">
          We don&apos;t like it either, but the yui-ani extension needs quite a few permissions to function. Listed
        ...
        <div className="card-list">
          ...
          <Card icon={<Icon name="network" />}>
            ...
            <p className="text-color paragraph">
              ...
              technical terms, this allows yui-ani to modify HTTP headers that it wouldn&apos;t normally be allowed to.
            </p>
            <p className="text-color paragraph">
